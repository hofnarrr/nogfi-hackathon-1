...
print(f"Uptime string {uptime_string}, uptime in seconds {time.uptime_string_to_seconds(uptime_string)}")
...
canonical_interface_names = [interface.canonical_interface_name(i) for i in interface_strings]
